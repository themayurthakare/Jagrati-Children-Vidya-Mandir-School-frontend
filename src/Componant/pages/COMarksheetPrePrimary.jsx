...
const COMarksheetPrePrimary = () => {
  ...
  // Subject visibility - Pre Primary: Hindi, English, Maths, Drawing, GK
  const [showDrawing, setShowDrawing] = useState(true); // Drawing is shown
  // GK is always shown
  ...
  const calculateExamTotal = (examType) => {
    ...
    // No EVS, Science, Social Science, Sanskrit for Pre Primary
    return total;
  };
  ...
  // Additional subjects for Pre Primary: Drawing and GK
...
export default COMarksheetPrePrimary;
