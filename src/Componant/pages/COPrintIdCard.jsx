...
const COPrintIdCard = () => {
  ...
  const goBack = () => {
    navigate("/computeroperator/generate-id-cards");
  };
          ...
          <div className="header-right">
            <div className="bulk-actions">
              <button
                ...
                onClick={() =>
                  navigate("/computeroperator/generate-id-cards/print-all", {
                    state: {
                      classId,
                      className,
                    },
                  ...
                  <td className="text-center">
                    <div className="action-buttons">
                      <button
                        ...
                        onClick={() =>
                          navigate(
                            "/computeroperator/generate-id-cards/print",
                            {
                              state: {
                      ...
                      <button
                        className="admit-btn"
                        onClick={() =>
                          navigate("/computeroperator/generate-admit-card", {
                            state: {
                              studentId: student.userId,
                              className,
                              studentName: student.name,
