...
const COUpdateClass = ({ apiBase = "http://localhost:8080" }) => {
  ...
  useEffect(() => {
    if (!classId) {
      ...
      setTimeout(() => navigate("/computeroperator/view-classes"), 2000);
      return;
    }
    ...
    const fetchClass = async () => {
      ...
      try {
        ...
        setTimeout(() => navigate("/computeroperator/view-classes"), 3000);
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (success) {
        ...
        setTimeout(() => {
          navigate("/computeroperator/view-classes");
        }, 1500);
      } else {
        throw new Error(
