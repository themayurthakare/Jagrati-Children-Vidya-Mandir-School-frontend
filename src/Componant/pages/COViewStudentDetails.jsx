...
const COViewStudentDetails = ({ apiBase = "http://localhost:8080" }) => {
  ...
  const handleBackToList = () => {
    navigate("/computeroperator/view-students");
  };
      ...
      <div className="vsd-actions">
        ...
        <div className="vsd-action-buttons">
          ...
          <button
            className="btn-print"
            onClick={() =>
              navigate("/computeroperator/print-student", {
                state: { studentId },
              })
            }
            disabled={!user}
...
export default COViewStudentDetails;
